...
class WeatherViewController: UIViewController, CLLocationManagerDelegate, ChangeCityDelegate {
    ...
    func userEnteredANewCityName (city : String){
        //use Alamofire to access openweathermap and query server
        let cityParams : [String : String] = ["q" : city, "appid" : forecastAPIKey]
        getWeatherData(url: WEATHER_URL, parameters: cityParams)
        //use JSON to receieve data and store it in
    }
